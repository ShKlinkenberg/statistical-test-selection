...
2. A mermaid graph is generated from this table by `csv_to_mermaid.R`
...
5. `mermaid_flowchart.qmd` uses `test_selection_flowchart.mmd` to visualise a static `SVG` flowchart.
